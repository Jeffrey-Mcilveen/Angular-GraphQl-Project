...
@Component({
  selector: 'app-search-bypostal',
  templateUrl: './search-bypostal.component.html',
  styleUrls: ['./search-bypostal.component.css']
})
export class SearchBypostalComponent implements OnInit {
